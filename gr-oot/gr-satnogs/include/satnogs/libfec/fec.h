...
SATNOGS_API int chainback_viterbi27_av(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi27_av(void *p);
SATNOGS_API int update_viterbi27_blk_av(void *p,unsigned char *syms,int nbits);
#endif
...
SATNOGS_API int chainback_viterbi27_mmx(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi27_mmx(void *p);
SATNOGS_API int update_viterbi27_blk_mmx(void *p,unsigned char *syms,int nbits);
...
SATNOGS_API int chainback_viterbi27_sse(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi27_sse(void *p);
SATNOGS_API int update_viterbi27_blk_sse(void *p,unsigned char *syms,int nbits);
...
SATNOGS_API int chainback_viterbi27_sse2(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi27_sse2(void *p);
SATNOGS_API int update_viterbi27_blk_sse2(void *p,unsigned char *syms,int nbits);
#endif
...
SATNOGS_API int chainback_viterbi29_av(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi29_av(void *p);
SATNOGS_API int update_viterbi29_blk_av(void *p,unsigned char *syms,int nbits);
#endif

#ifdef __i386__
SATNOGS_API void *create_viterbi29_mmx(int len);
SATNOGS_API void set_viterbi29_polynomial_mmx(int polys[2]);
SATNOGS_API int init_viterbi29_mmx(void *p,int starting_state);
SATNOGS_API int chainback_viterbi29_mmx(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi29_mmx(void *p);
SATNOGS_API int update_viterbi29_blk_mmx(void *p,unsigned char *syms,int nbits);
...
SATNOGS_API int chainback_viterbi29_sse(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi29_sse(void *p);
SATNOGS_API int update_viterbi29_blk_sse(void *p,unsigned char *syms,int nbits);
...
SATNOGS_API int chainback_viterbi29_sse2(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi29_sse2(void *p);
SATNOGS_API int update_viterbi29_blk_sse2(void *p,unsigned char *syms,int nbits);
#endif
...
SATNOGS_API int chainback_viterbi39_av(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi39_av(void *p);
SATNOGS_API int update_viterbi39_blk_av(void *p,unsigned char *syms,int nbits);
#endif
...
SATNOGS_API int chainback_viterbi39_mmx(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi39_mmx(void *p);
SATNOGS_API int update_viterbi39_blk_mmx(void *p,unsigned char *syms,int nbits);
...
SATNOGS_API int chainback_viterbi39_sse(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi39_sse(void *p);
SATNOGS_API int update_viterbi39_blk_sse(void *p,unsigned char *syms,int nbits);
...
SATNOGS_API int chainback_viterbi39_sse2(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi39_sse2(void *p);
SATNOGS_API int update_viterbi39_blk_sse2(void *p,unsigned char *syms,int nbits);
#endif
...
SATNOGS_API int chainback_viterbi615_av(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi615_av(void *p);
SATNOGS_API int update_viterbi615_blk_av(void *p,unsigned char *syms,int nbits);
#endif
...
SATNOGS_API int chainback_viterbi615_mmx(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi615_mmx(void *p);
SATNOGS_API int update_viterbi615_blk_mmx(void *p,unsigned char *syms,int nbits);
...
SATNOGS_API int chainback_viterbi615_sse(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi615_sse(void *p);
SATNOGS_API int update_viterbi615_blk_sse(void *p,unsigned char *syms,int nbits);
...
SATNOGS_API int chainback_viterbi615_sse2(void *p,unsigned char *data,unsigned int nbits,unsigned int endstate);
SATNOGS_API void delete_viterbi615_sse2(void *p);
SATNOGS_API int update_viterbi615_blk_sse2(void *p,unsigned char *syms,int nbits);
#endif
...
SATNOGS_API void find_cpu_mode(void); /* Call this once at startup to set Cpu_mode */
