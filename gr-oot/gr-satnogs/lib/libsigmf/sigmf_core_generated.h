    ...
    &_fbb, const GlobalT *_o, const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _description = _o->description.empty() ? 0 : _fbb.CreateString(
                        _o->description);
                              ...
                              const flatbuffers::resolver_function_t *_resolver) const
{
  ...
  (void)_resolver;
  {
    auto _e = sample_start();
    _o->sample_start = _e;
  };
  {
    auto _e = global_index();
    _o->global_index = _e;
  };
  {
    auto _e = frequency();
                                 ...
                                 const flatbuffers::resolver_function_t *_resolver) const
{
  ...
  (void)_resolver;
  {
    auto _e = freq_lower_edge();
    _o->freq_lower_edge = _e;
  };
  {
    auto _e = freq_upper_edge();
    _o->freq_upper_edge = _e;
  };
  {
    auto _e = sample_start();
    _o->sample_start = _e;
